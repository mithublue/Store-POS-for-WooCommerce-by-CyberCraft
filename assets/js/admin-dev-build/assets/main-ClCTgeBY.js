...
function FiBarChart2(props) {
  return GenIcon({ "attr": { "viewBox": "0 0 24 24", "fill": "none", "stroke": "currentColor", "strokeWidth": "2", "strokeLinecap": "round", "strokeLinejoin": "round" }, "child": [{ "tag": "line", "attr": { "x1": "18", "y1": "20", "x2": "18", "y2": "10" } }, { "tag": "line", "attr": { "x1": "12", "y1": "20", "x2": "12", "y2": "4" } }, { "tag": "line", "attr": { "x1": "6", "y1": "20", "x2": "6", "y2": "14" } }] })(props);
}
...
function FiEdit2(props) {
  return GenIcon({ "attr": { "viewBox": "0 0 24 24", "fill": "none", "stroke": "currentColor", "strokeWidth": "2", "strokeLinecap": "round", "strokeLinejoin": "round" }, "child": [{ "tag": "path", "attr": { "d": "M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" } }] })(props);
}
function FiHome(props) {
  return GenIcon({ "attr": { "viewBox": "0 0 24 24", "fill": "none", "stroke": "currentColor", "strokeWidth": "2", "strokeLinecap": "round", "strokeLinejoin": "round" }, "child": [{ "tag": "path", "attr": { "d": "M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" } }, { "tag": "polyline", "attr": { "points": "9 22 9 12 15 12 15 22" } }] })(props);
}
function FiMapPin(props) {
  return GenIcon({ "attr": { "viewBox": "0 0 24 24", "fill": "none", "stroke": "currentColor", "strokeWidth": "2", "strokeLinecap": "round", "strokeLinejoin": "round" }, "child": [{ "tag": "path", "attr": { "d": "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" } }, { "tag": "circle", "attr": { "cx": "12", "cy": "10", "r": "3" } }] })(props);
}
...
function FiSave(props) {
  return GenIcon({ "attr": { "viewBox": "0 0 24 24", "fill": "none", "stroke": "currentColor", "strokeWidth": "2", "strokeLinecap": "round", "strokeLinejoin": "round" }, "child": [{ "tag": "path", "attr": { "d": "M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z" } }, { "tag": "polyline", "attr": { "points": "17 21 17 13 7 13 7 21" } }, { "tag": "polyline", "attr": { "points": "7 3 7 8 15 8" } }] })(props);
}
...
function FiTrendingUp(props) {
  return GenIcon({ "attr": { "viewBox": "0 0 24 24", "fill": "none", "stroke": "currentColor", "strokeWidth": "2", "strokeLinecap": "round", "strokeLinejoin": "round" }, "child": [{ "tag": "polyline", "attr": { "points": "23 6 13.5 15.5 8.5 10.5 1 18" } }, { "tag": "polyline", "attr": { "points": "17 6 23 6 23 12" } }] })(props);
}
...
const AdminLayout = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-64 bg-white border-r border-gray-200 flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-16 flex items-center px-6 border-b border-gray-200", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FiShoppingBag, { className: "text-primary-500 text-2xl mr-3" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-primary-500", children: "Store POS" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 px-3 py-4 space-y-1", children: navigation.map((item) => {
        const Icon = item.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to: item.path,
            className: `flex items-center px-3 py-2.5 rounded-lg text-sm font-medium transition-all ${isActive(item.path) ? "bg-primary-500 text-white shadow-md" : "text-gray-700 hover:bg-gray-100"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "mr-3", size: 20 }),
              item.name
            ]
          },
          item.path
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-t border-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 text-center", children: "Store POS v1.0.0" }) })
    ] }),
...
const Dashboard = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-8", children: "Dashboard" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-1", children: "Today's Sales" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-gray-900", children: "$0.00" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 bg-primary-100 rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiDollarSign, { className: "text-primary-500 text-2xl" }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-1", children: "Orders" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-gray-900", children: "0" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 bg-green-100 rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiShoppingBag, { className: "text-green-600 text-2xl" }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-1", children: "Customers" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-gray-900", children: "0" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiUsers, { className: "text-blue-600 text-2xl" }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 mb-1", children: "Avg Order" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-gray-900", children: "$0.00" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 bg-purple-100 rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiTrendingUp, { className: "text-purple-600 text-2xl" }) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card text-center py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-2", children: "Welcome to Store POS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "Dashboard analytics coming soon..." })
    ] })
  ] });
};
...
api.interceptors.response.use(
  ...
  (error) => {
    var _a2, _b;
    const message = ((_b = (_a2 = error.response) == null ? void 0 : _a2.data) == null ? void 0 : _b.message) || error.message || "An error occurred";
...
const OutletModal = ({ outlet, onClose, onSave }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-overlay", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal-content", onClick: (e2) => e2.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-6 border-b border-gray-200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-gray-900", children: outlet ? "Edit Outlet" : "Create New Outlet" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit, className: "flex-1 overflow-y-auto p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Outlet Name *" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Leave empty to auto-generate" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Address" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            name: "address",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Timezone" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "America/New_York", children: "America/New_York" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "America/Chicago", children: "America/Chicago" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "America/Denver", children: "America/Denver" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "America/Los_Angeles", children: "America/Los_Angeles" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Europe/London", children: "Europe/London" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Asia/Dhaka", children: "Asia/Dhaka" })
            ]
          }
        )
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 p-6 border-t border-gray-200 bg-gray-50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          disabled: loading,
          children: loading ? "Saving..." : outlet ? "Update Outlet" : "Create Outlet"
        }
      )
    ] })
  ] }) });
...
const Outlets = () => {
  ...
  const [editingOutlet, setEditingOutlet] = reactExports.useState(null);
  reactExports.useEffect(() => {
    loadOutlets();
  }, []);
  const loadOutlets = async () => {
    ...
    try {
      ...
      zt.error("Failed to load outlets");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDelete = async (id2) => {
    ...
    try {
      await outletsAPI.delete(id2);
      zt.success("Outlet deleted successfully");
      loadOutlets();
    } catch (error) {
      zt.error(error.message || "Failed to delete outlet");
    }
  };
  const handleSave = async (data) => {
    try {
      if (editingOutlet) {
        ...
        zt.success("Outlet updated successfully");
      } else {
        await outletsAPI.create(data);
        zt.success("Outlet created successfully");
      }
      setShowModal(false);
      loadOutlets();
    } catch (error) {
      zt.error(error.message || "Failed to save outlet");
      throw error;
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "Outlets" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mt-1", children: "Manage your store locations" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleCreate, className: "btn btn-primary flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FiPlus, { size: 20 }),
        "Add Outlet"
      ] })
    ] }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-primary-500" }) }) : outlets.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card text-center py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FiMapPin, { className: "mx-auto text-gray-400 text-5xl mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: "No outlets yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mb-4", children: "Get started by creating your first outlet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleCreate, className: "btn btn-primary", children: "Add Your First Outlet" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: outlets.map((outlet) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card hover:shadow-lg transition-shadow", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiMapPin, { className: "text-primary-500 text-xl" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-gray-900", children: outlet.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `badge ${outlet.status === "active" ? "badge-success" : "badge-danger"}`, children: outlet.status })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm text-gray-600 mb-4", children: [
        outlet.address && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Address:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: outlet.address })
        ] }),
        outlet.phone && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Phone:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: outlet.phone })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-4 border-t border-gray-200", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FiEdit2, { size: 16 }),
              "Edit"
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FiTrash2, { size: 16 }),
              "Delete"
            ]
          }
        )
...
const DrawerModal = ({ drawer, outlets, onClose, onSave }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "modal-overlay", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "modal-content", onClick: (e2) => e2.stopPropagation(), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-6 border-b border-gray-200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-gray-900", children: drawer ? "Edit Drawer" : "Create New Drawer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "text-gray-400 hover:text-gray-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiX, { size: 24 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit, className: "flex-1 overflow-y-auto p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Drawer Name *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Outlet *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            name: "outlet_id",
            ...
            required: true,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Select an outlet" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Printer Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Optional: Receipt printer name" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Status" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 p-6 border-t border-gray-200 bg-gray-50", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: "flex-1 btn btn-primary",
          disabled: loading,
          children: loading ? "Saving..." : drawer ? "Update Drawer" : "Create Drawer"
        }
      )
    ] })
  ] }) });
...
const Drawers = () => {
  const [drawers, setDrawers] = reactExports.useState([]);
  const [outlets, setOutlets] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(true);
  const [showModal, setShowModal] = reactExports.useState(false);
  const [editingDrawer, setEditingDrawer] = reactExports.useState(null);
  reactExports.useEffect(() => {
    loadData();
  }, []);
  ...
  const handleCreate = () => {
    if (outlets.length === 0) {
      zt.error("Please create an outlet first");
      return;
    }
  ...
  const handleDelete = async (id2) => {
    ...
    try {
      await drawersAPI.delete(id2);
      zt.success("Drawer deleted successfully");
      loadData();
    } catch (error) {
      zt.error(error.message || "Failed to delete drawer");
    }
  };
  const handleSave = async (data) => {
    try {
      if (editingDrawer) {
        ...
        zt.success("Drawer updated successfully");
      } else {
        await drawersAPI.create(data);
        zt.success("Drawer created successfully");
      }
      setShowModal(false);
      loadData();
    } catch (error) {
      zt.error(error.message || "Failed to save drawer");
      throw error;
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "Drawers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mt-1", children: "Manage cash registers for your outlets" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: handleCreate, className: "btn btn-primary flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FiPlus, { size: 20 }),
        "Add Drawer"
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-primary-500" }) }) : drawers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card text-center py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FiBox, { className: "mx-auto text-gray-400 text-5xl mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-gray-900 mb-2", children: "No drawers yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mb-4", children: outlets.length === 0 ? "Create an outlet first, then add drawers" : "Get started by creating your first drawer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleCreate, className: "btn btn-primary", disabled: outlets.length === 0, children: "Add Your First Drawer" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "data-table", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Outlet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Printer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Status" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Actions" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: drawers.map((drawer) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-primary-100 rounded-lg flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiBox, { className: "text-primary-500" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: drawer.name })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: getOutletName(drawer.outlet_id) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: drawer.printer || "-" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `badge ${drawer.status === "active" ? "badge-success" : "badge-danger"}`, children: drawer.status }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              title: "Edit",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(FiEdit2, { size: 18 })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
...
const Reports = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-8", children: "Reports" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card text-center py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FiBarChart2, { className: "mx-auto text-gray-400 text-6xl mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-2", children: "Reports Module" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "Comprehensive reports and analytics coming soon..." })
    ] })
  ] });
};
const defaultSettings = ((_a = window.storePOSAdmin) == null ? void 0 : _a.settings) || {};
const themes = [
...
const Settings = () => {
  ...
  const loadSettings = async () => {
    ...
    try {
      ...
      zt.error(error.message || "Failed to load settings");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.success) {
        zt.success(response.message || "Settings saved");
        setForm({
      ...
      zt.error(error.message || "Failed to save settings");
    } finally {
      setSaving(false);
    }
  };
  const generalSettings = reactExports.useMemo(() => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-4", children: "General" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Theme" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            className: "input",
            value: form.theme,
            onChange: (e2) => handleChange("theme", e2.target.value),
            children: themes.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, children: option.label }, option.value))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Layout" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            className: "input",
            value: form.layout,
            onChange: (e2) => handleChange("layout", e2.target.value),
            children: layouts.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, children: option.label }, option.value))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "autoPrint",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "autoPrint", className: "text-sm text-gray-700", children: "Automatically print receipt after checkout" })
      ] })
    ] })
  ] }), [form.auto_print, form.layout, form.theme]);
  const barcodeSettings = reactExports.useMemo(() => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-4", children: "Barcode" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Barcode Format" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            className: "input",
            value: form.barcode_format,
            onChange: (e2) => handleChange("barcode_format", e2.target.value),
            children: barcodeFormats.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, children: option.label }, option.value))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Barcode Scanner Field" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            className: "input",
            value: form.barcode_field,
            onChange: (e2) => handleChange("barcode_field", e2.target.value),
            children: barcodeFields.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, children: option.label }, option.value))
          }
        )
      ] })
    ] })
  ] }), [form.barcode_field, form.barcode_format]);
  const taxSettings = reactExports.useMemo(() => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-4", children: "Tax" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Tax Display" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            className: "input",
            value: form.tax_display,
            onChange: (e2) => handleChange("tax_display", e2.target.value),
            children: taxDisplayOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, children: option.label }, option.value))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Tax Rounding" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            className: "input",
            value: form.tax_rounding,
            onChange: (e2) => handleChange("tax_rounding", e2.target.value),
            children: taxRoundingOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, children: option.label }, option.value))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "feeTax", className: "text-sm text-gray-700", children: "Calculate tax on additional fees (e.g. service charges)" })
      ] })
    ] })
  ] }), [form.calculate_fee_tax, form.tax_display, form.tax_rounding]);
  const layoutSettings = reactExports.useMemo(() => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-4", children: "Layout & Product Grid" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Products per row" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: productsPerRowOptions.map((value) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          className: `px-4 py-2 rounded-lg border text-sm font-medium transition-colors ${form.products_per_row === value ? "border-primary-500 bg-primary-50 text-primary-700" : "border-gray-300 hover:border-primary-300"}`,
          onClick: () => handleChange("products_per_row", value),
          children: value
        },
        value
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-2", children: "Controls the number of product tiles shown in the POS product grid. Higher values show more products per row but each tile becomes smaller." })
    ] })
  ] }), [form.products_per_row]);
  const receiptSettings = reactExports.useMemo(() => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold text-gray-900 mb-4", children: "Receipt" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Receipt Header" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            className: "input h-32",
            value: form.receipt_header,
            onChange: (e2) => handleChange("receipt_header", e2.target.value),
            placeholder: "Store name, address, contact info..."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Appears at the top of printed receipts." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Receipt Footer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            className: "input h-32",
            value: form.receipt_footer,
            onChange: (e2) => handleChange("receipt_footer", e2.target.value),
            placeholder: "Thank you message, return policy, etc."
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1", children: "Appears at the bottom of printed receipts." })
      ] })
    ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 mt-1", children: "Configure the POS experience for your staff and customers." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FiRefreshCw, { className: loading ? "animate-spin" : "" }),
              "Reload"
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FiSave, {}),
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card py-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FiRefreshCw, { className: "text-primary-500 text-3xl animate-spin" }),
...
const AppContent = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: initialRoute, replace: true }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/dashboard", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Dashboard, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/outlets", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlets, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/drawers", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Drawers, {}) }),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(HashRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, {}) });
}
const rootElement = document.getElementById("store-pos-admin-root");
if (!rootElement) {
  console.error("Store POS admin root element not found");
}
let root;
...
try {
  ...
  console.error("Failed to mount POS admin app:", error);
  if (rootElement) {
    rootElement.innerHTML = `
        <div style="padding: 2rem; background: #fee; border: 1px solid #fcc; border-radius: 8px; margin: 1rem;">
          <h2 style="color: #c00; margin-bottom: 1rem;">Failed to load POS Admin</h2>
...
//# sourceMappingURL=main-ClCTgeBY.js.map
